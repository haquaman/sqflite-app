// ignore_for_file: use_key_in_widget_constructors, unnecessary_new, prefer_const_constructors, prefer_const_literals_to_create_immutables, deprecated_member_use, avoid_unnecessary_containers, sized_box_for_whitespace, avoid_function_literals_in_foreach_calls
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _insert(name, miles) async {
    ...
    Get.snackbar(
      'Bilgilendirme',
      'Araba $id numaralı id ile eklenildi',
    );
  }
  ...
  void _update(id, name, miles) async {
    ...
    Get.snackbar(
      'Bilgilendirme',
      '$id indexli araba güncellenildi',
    );
  }
  ...
  void _delete(id) async {
    ...
    Get.snackbar(
      'Bilgilendirme',
      '$id indexli araba databaseden silindi',
    );
  }
}
